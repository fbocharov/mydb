...
public:
	...
	PageID GetLEChildPage(size_t entryNumber) const;
...
template<typename KeyT>
KeyT InnerNode<KeyT>::GetKey(size_t entryNumber) const {
	size_t offset = CalculateEntryOffset(entryNumber) + sizeof(PageID);
